...
/****************************************************************************/
/* BlockArray. TODO move to a separate file.                                */
/****************************************************************************/
...
TEST_CASE ("ZoomOut", "[backend]")
{
        ...
        SECTION ("zoomOut 2")
        {
                ...
                // TODO Do not check for channel equality just yet, because I plan to amend downsample algorithms a bit.
                // REQUIRE (copy.channel (0) == Bytes{0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xa, 0xb});
        }
...
/****************************************************************************/
/* Backend. TODO move to a separate file.                                   */
/****************************************************************************/
